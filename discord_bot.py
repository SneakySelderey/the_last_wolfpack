...
Coordinates of loss: {data['coords']}.""")
    ...
    async def website(self, ctx):
        ...
        embedVar.add_field(name="3.", value="[Карта мест гибели подлодок](https://the-last-wolfpack.herokuapp.com/map)", inline=False)
        embedVar.add_field(name="4.", value="[Подводные лодки Кригсмарине](https://the-last-wolfpack.herokuapp.com/uboats)", inline=False)
        embedVar.add_field(name="5.", value="[Капитаны Кригсмарине](https://the-last-wolfpack.herokuapp.com/captains)", inline=False)
